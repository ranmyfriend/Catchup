...
public final class GetAllCountriesQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Country: GraphQLSelectionSet {
      ...
      public init(code: GraphQLID, name: String, native: String, currency: String? = nil, emoji: String, capital: String? = nil) {
        self.init(unsafeResultMap: ["__typename": "Country", "code": code, "name": name, "native": native, "currency": currency, "emoji": emoji, "capital": capital])
      }
